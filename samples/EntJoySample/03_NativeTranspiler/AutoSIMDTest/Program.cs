...
//            double LEnIP = ChRun(() => { World.DefaultWorld = lightWorld; new MoveJobEntity_ISPC { DeltaTime = dt }.Schedule(query).Complete(); });
...
//            double HEnIP = ChRun(() => { World.DefaultWorld = heavyWorld; new HeavyJobEntity_ISPC { DeltaTime = dt }.Schedule(query).Complete(); });

//            Console.WriteLine($"  {"LightMove",-9} {LChCpp,5:F3} {LChSD,5:F3} {LChIP,5:F3}   {LEnCpp,5:F3} {LEnSD,5:F3} {"N/A",5} {LEnIP,5:F3}");
//            Console.WriteLine($"  {"HeavyMove",-9} {HChCpp,5:F3} {HChSD,5:F3} {HChVZ,5:F3} {HChIP,5:F3} {HEnCpp,5:F3} {HEnSD,5:F3} {HEnVZ,5:F3} {HEnIP,5:F3}");
//            Console.WriteLine(sep);
