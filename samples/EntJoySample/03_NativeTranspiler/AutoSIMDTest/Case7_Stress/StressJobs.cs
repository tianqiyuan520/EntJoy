...
namespace EntJoySample.AutoSIMDTest
{
    ...
    // ── ST1: 娣卞眰 if-else-if 閾撅紙5 鍒嗘敮锛夆攢─
    ...
    // ── ST3: 鍐呭眰寰幆 + 鍒嗘敮锛坧arity accumulate锛夆攢─
    ...
    // ── ST7: reduction 鍙岀疮绉紙min + max 澶氬彉閲忥級+ 鍒嗘敮 ──
    ...
    // ── ST10: gather + 鍒嗘敮绱姞锛堝鏁扮粍绱㈠紩锛夆攢─
