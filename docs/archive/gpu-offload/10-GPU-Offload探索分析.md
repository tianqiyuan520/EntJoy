...
> 关联：[00-项目布局](../layout/00-项目布局与EntJoySample设计意图.md)、[gridsearch/04-基准测量方法论](../../gridsearch/04-基准测量方法论与调度开销分析.md)、历史见 [archive/](../README.md)。
...
## 2. 基线事实（仓库实测，见 [archive/simd/auto-simd-ispc-gap-analysis.md](../simd/auto-simd-ispc-gap-analysis.md)）
