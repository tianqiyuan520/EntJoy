//
// D:/Godot/Project/EntJoy/src/EntJoySample/NativeTranspiler_Generated/SharpNative_EntJoy_MovementTest_MoveEntitiesTest_RunNativeIspcStatic_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void SharpNative_EntJoy_MovementTest_MoveEntitiesTest_RunNativeIspcStatic_impl(struct float2 * pos_ptr, int32_t pos_length, struct float2 * vel_ptr, int32_t vel_length, int32_t * count_ptr);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
