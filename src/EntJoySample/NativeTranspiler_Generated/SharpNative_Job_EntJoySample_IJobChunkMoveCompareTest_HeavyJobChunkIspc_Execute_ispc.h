//
// D:/Godot/Project/EntJoy/src/EntJoySample/NativeTranspiler_Generated/SharpNative_Job_EntJoySample_IJobChunkMoveCompareTest_HeavyJobChunkIspc_Execute_ispc.h
...
#ifndef __ISPC_STRUCT_MovePosition__
#define __ISPC_STRUCT_MovePosition__
struct MovePosition {
    struct float2 Value;
};
#endif

#ifndef __ISPC_STRUCT_MoveVelocity__
#define __ISPC_STRUCT_MoveVelocity__
struct MoveVelocity {
    struct float2 Value;
};
#endif
...
extern "C" {
#endif // __cplusplus
    extern void SharpNative_Job_EntJoySample_IJobChunkMoveCompareTest_HeavyJobChunkIspc_Execute_impl(struct MovePosition * positions_ptr, int32_t positions_length, struct MoveVelocity * velocities_ptr, int32_t velocities_length, float * DeltaTime_ptr);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
