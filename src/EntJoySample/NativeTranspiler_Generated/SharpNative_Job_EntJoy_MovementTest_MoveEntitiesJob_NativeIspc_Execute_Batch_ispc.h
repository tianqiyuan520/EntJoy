//
// D:/Godot/Project/EntJoy/src/EntJoySample/NativeTranspiler_Generated/SharpNative_Job_EntJoy_MovementTest_MoveEntitiesJob_NativeIspc_Execute_Batch_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void SharpNative_Job_EntJoy_MovementTest_MoveEntitiesJob_NativeIspc_Execute_Batch_impl(int32_t, int32_t, struct float2 * Positions_ptr, int32_t Positions_length, struct float2 * Velocities_ptr, int32_t Velocities_length, float * Dt_ptr, float * ViewportWidth_ptr, float * ViewportHeight_ptr, int32_t * Count_ptr);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
