...
HEAD void CALLINGCONVENTION SharpNative_Job_EntJoy_MovementTest_MoveEntitiesJob_NativeIspc_Execute_Adapter(void* context, int __startIndex, int __count)
{
    ...
    SharpNative_Job_EntJoy_MovementTest_MoveEntitiesJob_NativeIspc_Execute_Batch(__startIndex, __count, Positions_ptr, Positions_length, Velocities_ptr, Velocities_length, Dt_ptr, ViewportWidth_ptr, ViewportHeight_ptr, Count_ptr);
}

HEAD void* CALLINGCONVENTION Get_SharpNative_Job_EntJoy_MovementTest_MoveEntitiesJob_NativeIspc_Execute_AdapterPtr()
{
    return (void*)SharpNative_Job_EntJoy_MovementTest_MoveEntitiesJob_NativeIspc_Execute_Adapter;
}
