...
#include "SharpNative_Job_EntJoySample_IJobChunkScheduleOverheadTest_EmptyChunkJobCpp_Execute.h"
...
HEAD void CALLINGCONVENTION SharpNative_Job_EntJoySample_IJobChunkScheduleOverheadTest_EmptyChunkJobCpp_Execute_Adapter(void* context, const ChunkJobData* __chunkData)
{
    ...
    SharpNative_Job_EntJoySample_IJobChunkScheduleOverheadTest_EmptyChunkJobCpp_Execute(__chunkData, __requiredComponentTypeIds);
}

HEAD void* CALLINGCONVENTION Get_SharpNative_Job_EntJoySample_IJobChunkScheduleOverheadTest_EmptyChunkJobCpp_Execute_AdapterPtr()
{
    return (void*)SharpNative_Job_EntJoySample_IJobChunkScheduleOverheadTest_EmptyChunkJobCpp_Execute_Adapter;
}
