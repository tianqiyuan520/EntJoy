//
// SharpNative_Job__global_namespace__ISPCFastJob_Execute_Batch_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void SharpNative_Job__global_namespace__ISPCFastJob_Execute_Batch_impl(int32_t, int32_t, float * Input_ptr, float * Output_ptr);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
