...
#include "SharpNative_Job_EntJoySample_IJobChunkMoveCompareTest_MoveJobEntityCpp_Execute.h"
...
HEAD void CALLINGCONVENTION SharpNative_Job_EntJoySample_IJobChunkMoveCompareTest_MoveJobEntityCpp_Execute_EntityBatchAdapter(void* context, const EntityBatchData* __batches, int __batch_start, int __batch_count)
{
    ...
    for (int __batch_index = __batch_start; __batch_index < __batch_end; ++__batch_index)
    {
        ...
        {
            __entity_param_0_ptr[__entity_index].Value += __entity_param_1_ptr[__entity_index].Value * DeltaTime;
        }
    }
}

HEAD void* CALLINGCONVENTION Get_SharpNative_Job_EntJoySample_IJobChunkMoveCompareTest_MoveJobEntityCpp_Execute_EntityBatchAdapterPtr()
{
    return (void*)SharpNative_Job_EntJoySample_IJobChunkMoveCompareTest_MoveJobEntityCpp_Execute_EntityBatchAdapter;
}
