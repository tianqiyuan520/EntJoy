//
// D:/Godot/Project/EntJoy/src/EntJoySample/NativeTranspiler_Generated/SharpNative_Job_EntJoySample_IJobChunkScheduleOverheadTest_AddOneChunkJobIspc_Execute_ispc.h
...
#ifndef __ISPC_STRUCT_ScheduleValue__
#define __ISPC_STRUCT_ScheduleValue__
...
extern "C" {
#endif // __cplusplus
    extern void SharpNative_Job_EntJoySample_IJobChunkScheduleOverheadTest_AddOneChunkJobIspc_Execute_impl(struct ScheduleValue * values_ptr, int32_t values_length);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
