//
// D:/Godot/Project/EntJoy/src/EntJoySample/NativeTranspiler_Generated/SharpNative_Job_EntJoySample_IJobChunkMoveCompareTest_HeavyJobEntityIspcMt_Execute_mt_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void SharpNative_Job_EntJoySample_IJobChunkMoveCompareTest_HeavyJobEntityIspcMt_Execute_mt_impl(struct MovePosition * position_ptr, struct MoveVelocity * velocity_ptr, int32_t, float * DeltaTime_ptr, int32_t numTasks);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
