//
// SharpNative__global_namespace__CpuFullLoadTest_Fill_mt_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void SharpNative__global_namespace__CpuFullLoadTest_Fill_mt_impl(float * data_ptr, float * output_ptr, int32_t numTasks);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
