//
// SharpNative__global_namespace__IspccComparison_FillIspcDefaultMT_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void SharpNative__global_namespace__IspccComparison_FillIspcDefaultMT_impl(float * data_ptr, float * output_ptr);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
