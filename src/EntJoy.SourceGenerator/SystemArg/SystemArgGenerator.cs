...
//    {{
//        virtual unsafe void _execute(Entity* _entity, {generalparamsArray},int _Count, int LimitCount, int ArchetypeIndex, int ChunkIndex) {{}}        
//        virtual void Execute(ref Entity entity, {generalparams}) {{}}
//        virtual void Execute({generalparams}) {{}}

//        // 每次判断到符合条件的Archetype时调用的接口
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        virtual void InArchetype(int id) {{ }}

//        // 每次判断到符合条件的Chunk时调用的接口
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        public virtual void InChunk(int ArchetypeIndex,int id) {{ }}
//    }}
//}}
//";
...
//                        system.InArchetype(ArchetypeIndex);
...
//                            if (count == 0) continue;
//                            int ChunkIndex = j;
//                            system.InChunk(ArchetypeIndex,ChunkIndex);
//                            {generalExp.ToString()}
//                            {{
//                                system._execute(entities, {generalparams}, count, limitCount - entityCounter, ArchetypeIndex, ChunkIndex);
//                            }}
//                            entityCounter += count;
...
//{generalArgsLimit}
//        {{
//            static void RunSystem(Chunk chunk, {GeneralExp2_Index2}, ISystem<{generalArgs}> system, int LimitCount,int ArchetypeIndex, int ChunkIndex)
//            {{
//                int count = chunk.EntityCount;
//                {generalExp}
//                    system._execute(entities, {generalparams}, count, LimitCount, ArchetypeIndex, ChunkIndex);
//            }}
...
//                            Task task = Task.Run(() =>
//                            {{
//                                RunSystem(chunk, {generalparams2}, system, spareCount, ArchetypeIndex, ChunkIndex);
//                            }}
//                            );
//                            tasks.Add(task);
//                            entityCounter += count;
