...
struct simd_mask {
    ...
    friend simd_mask operator|(simd_mask a, simd_mask b) { return simd_mask{ n_or_mask(a.m, b.m) }; }
    friend simd_mask operator^(simd_mask a, simd_mask b) { return simd_mask{ n_xor_mask(a.m, b.m) }; }
