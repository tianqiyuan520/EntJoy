...
HEAD void CALLINGCONVENTION SharpNative_Job__global_namespace__MoveSystemJobCpp_Execute_Adapter(void* context, const ChunkJobData* __chunkData)
{
    ...
    SharpNative_Job__global_namespace__MoveSystemJobCpp_Execute(__chunkData, __requiredComponentTypeIds, dt_ptr);
}

HEAD void* CALLINGCONVENTION Get_SharpNative_Job__global_namespace__MoveSystemJobCpp_Execute_AdapterPtr()
{
    return (void*)SharpNative_Job__global_namespace__MoveSystemJobCpp_Execute_Adapter;
}
