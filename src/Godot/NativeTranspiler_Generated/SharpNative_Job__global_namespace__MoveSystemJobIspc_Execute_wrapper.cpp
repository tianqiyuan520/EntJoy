...
#include "SharpNative_Job__global_namespace__MoveSystemJobIspc_Execute_ispc.h"
...
HEAD void CALLINGCONVENTION SharpNative_Job__global_namespace__MoveSystemJobIspc_Execute_Adapter(void* context, const ChunkJobData* __chunkData)
{
    ...
    ispc::SharpNative_Job__global_namespace__MoveSystemJobIspc_Execute_impl(positions_ptr, positions_length, velocities_ptr, velocities_length, dt_ptr);
}
