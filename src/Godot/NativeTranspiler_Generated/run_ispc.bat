...
echo Compiling SharpNative_Job__global_namespace__MoveSystemJobEntityIspc_Execute.ispc...
"%ISPC%" "SharpNative_Job__global_namespace__MoveSystemJobEntityIspc_Execute.ispc" -o "build\SharpNative_Job__global_namespace__MoveSystemJobEntityIspc_Execute.obj" -h "SharpNative_Job__global_namespace__MoveSystemJobEntityIspc_Execute_ispc.h" --target=avx512skx-i32x16 --math-lib=fast --opt=disable-fma
if errorlevel 1 (
    echo Failed to compile SharpNative_Job__global_namespace__MoveSystemJobEntityIspc_Execute.ispc
    exit /b 1
)
