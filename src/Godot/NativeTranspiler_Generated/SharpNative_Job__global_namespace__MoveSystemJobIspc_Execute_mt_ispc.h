//
// SharpNative_Job__global_namespace__MoveSystemJobIspc_Execute_mt_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void SharpNative_Job__global_namespace__MoveSystemJobIspc_Execute_mt_impl(struct Position * positions_ptr, int32_t positions_length, struct Vel * velocities_ptr, int32_t velocities_length, float * dt_ptr, int32_t, int32_t numTasks);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
