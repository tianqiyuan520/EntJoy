//
// D:/Godot/Project/EntJoy/src/Godot/NativeTranspiler_Generated/SharpNative_Job__global_namespace__MoveSystemJobEntityIspc_Execute_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void SharpNative_Job__global_namespace__MoveSystemJobEntityIspc_Execute_impl(struct Position * position_ptr, struct Vel * velocity_ptr, int32_t, float * dt_ptr);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
