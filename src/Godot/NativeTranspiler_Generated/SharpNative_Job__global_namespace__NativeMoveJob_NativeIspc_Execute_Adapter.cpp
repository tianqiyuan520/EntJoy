...
HEAD void CALLINGCONVENTION SharpNative_Job__global_namespace__NativeMoveJob_NativeIspc_Execute_Batch(int __startIndex, int __count, EntJoy::Mathematics::float2* RESTRICT Positions_ptr, int Positions_length, EntJoy::Mathematics::float2* RESTRICT Velocities_ptr, int Velocities_length, float* RESTRICT Dt_ptr, float* RESTRICT ViewportWidth_ptr, float* RESTRICT ViewportHeight_ptr);

HEAD void CALLINGCONVENTION SharpNative_Job__global_namespace__NativeMoveJob_NativeIspc_Execute_Adapter(void* context, int __startIndex, int __count)
{
    ...
    SharpNative_Job__global_namespace__NativeMoveJob_NativeIspc_Execute_Batch(__startIndex, __count, Positions_ptr, Positions_length, Velocities_ptr, Velocities_length, Dt_ptr, ViewportWidth_ptr, ViewportHeight_ptr);
}

HEAD void* CALLINGCONVENTION Get_SharpNative_Job__global_namespace__NativeMoveJob_NativeIspc_Execute_AdapterPtr()
{
    return (void*)SharpNative_Job__global_namespace__NativeMoveJob_NativeIspc_Execute_Adapter;
}
